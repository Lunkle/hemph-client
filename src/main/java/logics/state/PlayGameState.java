...
public class PlayGameState extends GameState {
	...
	private void positionCamera() {
		getCamera().setPosition(0, 9f, 1f, 0);
		getCamera().setRotation(new Vector3f(1, 0, 0), -30);
	}
	...
	public void initialize() {
		...
		Command returnToTableViewCommand = new Command(() -> {
			...
			getCamera().setPosition(0, 9f, 1f, 0.5f);
			getCamera().setRotation(new Vector3f(1, 0, 0), -30, 0.5f);
		});
