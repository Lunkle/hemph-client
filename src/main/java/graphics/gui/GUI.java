...
public class GUI extends RawModel {
	...
	protected void setDimensions(float posX, float posY, float width, float height) {
		modelTransformation = new ModelTransformation(2.0f * posX / Visual.getWindowWidth() - 1.0f, 1.0f - 2.0f * posY / Visual.getWindowHeight(), 0, 0, 0, 0, 2.0f * width / Visual.getWindowWidth(), 2.0f * height / Visual.getWindowWidth(), 1);
	}
